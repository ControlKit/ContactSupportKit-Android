...
import com.sepanta.controlkit.contactsupportkit.R
...
import com.sepanta.controlkit.contactsupportkit.theme.Black40
...
class ContactSupportPopover1 : ContactSupportContract {
    ...
    override fun ShowView(
        ...
        Dialog(
            onDismissRequest = { openDialog.value = true }, properties = DialogProperties(
    ...
    @Composable
    private fun HeaderIcon(config: ContactSupportViewConfig) {

        Icon(
            modifier =config.imageLayoutModifier?: Modifier
                .width(20.dp)
                .height(20.dp),
            painter = painterResource(id = config.updateImageDrawble ?: R.drawable.complain),
            contentDescription = null,
            tint = config.updateImageColor ?: Black40
        )
    }
    ...
    private fun HeaderTitle(
        ...
        config.headerTitleView?.let { textView ->
            ...
            color = config.subjectTitleColor ?: Typography.titleMedium.color
    ...
    private fun SubjectLayout(
        ...
        Column(
            modifier = config.subjectLayoutModifier ?: Modifier
                .padding(
                    top = 26.dp, start = 14.dp, end = 14.dp
                )
                .fillMaxWidth()
                .wrapContentHeight(),
    ...
    private fun EmailLayout(
        ...
        Column(
            modifier = config.emailLayoutModifier ?: Modifier
                .padding(
                    top = 10.dp, start = 14.dp, end = 14.dp
                )
                .fillMaxWidth()
                .wrapContentHeight(),
            horizontalAlignment = Alignment.Start,
    ...
    private fun Buttons(
        ...
        Column(
            modifier = config.buttonsLayoutModifier ?: Modifier.padding(
                top = 16.dp, start = 14.dp, end = 14.dp, bottom = 24.dp
            ),
            horizontalAlignment = Alignment.CenterHorizontally,
